...
window.PROJECTS = [
  {
    ...
    body: [
      ...
      "## How it works",
      "The engine autonomously cross-references biological targets against chemical constraints to verify whether a candidate is worth pursuing. Multiple agents reason over different compounds in parallel, then their conclusions are aggregated into a kind of consensus mechanism.",
  ...
  },
  {
    ...
    body: [
      "## Overview",
      "I set out to create and launch my own token on Ethereum in under 30 minutes, then documented the entire process as a guide so anyone could make their own.",
      "## Why",
